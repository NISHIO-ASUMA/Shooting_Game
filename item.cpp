...
namespace ITEMINFO
{
	constexpr int UPPER_HP = 1;		  // 体力の加算量
	constexpr float HITRANGE = 75.0f; // 当たり半径の範囲
	constexpr float ROTVALUE = 0.03f; // 回転角の加算量
	constexpr const char* GUARDMODEL = "data\\MODEL\\STAGEOBJ\\Guard000.x"; // モデルパス
	constexpr const char* LIFEMOODEL = "data\\MODEL\\STAGEOBJ\\Item_life.x"; // モデルパス
};
